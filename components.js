...
<nav id="navbar">
  ...
  <a href="${WA_BASE}?text=Hola%2C%20quiero%20reservar%20mi%20fecha%20%F0%9F%93%B8" target="_blank" rel="noopener noreferrer" class="nav-cta">Reservar Fecha</a>
  <button class="nav-toggle" onclick="toggleMobileMenu()" aria-label="Menú">
    <span></span><span></span><span></span>
  </button>
</nav>
<div class="mobile-menu" id="mobileMenu">
  <button class="mobile-menu-close" onclick="toggleMobileMenu()" aria-label="Cerrar">✕</button>
  ${mobileLinks}
</div>`;
}
